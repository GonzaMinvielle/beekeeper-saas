...
export default function TaskForm({ hives }: { hives: HiveWithApiary[] }) {
  ...
  return (
    <div className="max-w-xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Nueva tarea</h1>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        ...
        <form action={action} className="space-y-5">
          <div>
            ...
            <input name="title" type="text" required placeholder="Describí la tarea..."
          ...
          <div className="flex items-center gap-3 pt-2">
            <SubmitButton />
            <Link href="/dashboard/tasks" className="px-5 py-2.5 text-sm text-gray-600 hover:text-gray-800 font-medium">
              Cancelar
            </Link>
          </div>
        </form>
